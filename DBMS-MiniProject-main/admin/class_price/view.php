...
<div class="h2 text-center">Virgin Airlines</div><br><br>
    <center><h2 style="font-weight: 800;"> Class Price Table </h2></center><br><br>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="update.php?id=<?php echo $row["class_id"]; ?>" class="btn btn-primary"> Update </a>
                    <a href="delete.php?id=<?php echo $row["class_id"]; ?>" class="btn btn-danger"> Delete </a>
                </td>
