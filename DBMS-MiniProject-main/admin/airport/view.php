...
<div class="h2 text-center">Virgin Airlines</div><br><br>
    <center><h2 style="font-weight: 800;"> Airport Table </h2></center><br><br>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="update.php?code=<?php echo $row["airport_code"]; ?>" class="btn btn-primary"> Update </a>
                    <a href="delete.php?code=<?php echo $row["airport_code"]; ?>" class="btn btn-danger"> Delete </a>
                </td>
